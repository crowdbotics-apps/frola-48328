"""
Django settings for frola_48328 project.
...
WSGI_APPLICATION = 'frola_48328.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frola_48328 API",
    "DESCRIPTION": "API documentation for frola_48328 App",
    "VERSION": "v1",
}
